...
lib/
  ...
  lesson-files.js        Leçons d'oral : fichiers .tex du sous-dossier lecons/ (métadonnées, tri, renommage) — Node pur, testé (npm test)
...
test/run-tests.js        Tests unitaires (npm test) — 35 tests, sans Electron
